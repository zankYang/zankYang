# Backend Developer (AdonisJS & Laravel)

Building backend services and APIs focused on clean architecture, security, and maintainability.
...
![Nuxt](https://img.shields.io/badge/Nuxt_Content-00DC82?style=for-the-badge&logo=nuxtdotjs&logoColor=white)
...
- Testing and documentation (OpenAPI/Swagger when needed)

---

## How I work
- Clean code and consistent architecture
- Defensive programming and input validation
- Logging, error handling, and observability basics
- Documentation-first when collaborating
